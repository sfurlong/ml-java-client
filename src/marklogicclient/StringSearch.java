...
import marklogicclient.Util.ExampleProperties;
...
//	public static void run(ExampleProperties props)
	...
	throws IOException, ResourceNotFoundException, ForbiddenUserException, FailedRequestException, ResourceNotResendableException {
		...
		//configure("localhost", 8010,
		//		"admin", "marklogic1", Authentication.DIGEST);

		search("localhost", 8010,
				"admin", "marklogic1", Authentication.DIGEST);

		//tearDownExample("localhost", 8013,
		//		"admin", "marklogic1", Authentication.DIGEST);
